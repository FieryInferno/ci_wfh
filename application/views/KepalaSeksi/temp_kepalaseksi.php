 ...
 <!-- Main Sidebar Container -->
  <aside class="main-sidebar elevation-4 sidebar-light-primary">
    ...
    <a href="../../index3.html" class="brand-link">
       <img src="<?php echo base_url();?>assets/img/bpslogo.png" alt="AdminLTE Logo" width="60px" height= "50px" 
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <a href="<?php echo base_url()."index.php/KepalaSeksi/KepalaSeksi/daftar_pekerjaan"?>" class="nav-link">
             ...
             <li class="nav-item">
            <a href="<?php echo base_url()."index.php/KepalaSeksi/KepalaSeksi/data_alokasi"?>" class="nav-link">
              <i class="nav-icon fas fa-edit" style="color :#339af0;"></i>
              <p>
                Alokasi Pekerjaan
              </p>
