        ...
        <aside class="main-sidebar elevation-4 sidebar-light-primary">
          ...
          <a href="../../index3.html" class="brand-link">
            ...
            <span class="brand-text font-weight-light">
              <font size = "5" face= "Tahoma ">SIMPEL BPS</font>
            </span>
          </a>
          <!-- Sidebar -->
          <div class="sidebar">
            ...
            <nav class="mt-2">
              <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
               ...
               <li class="nav-item">
                 <a href="<?= base_url(); ?>tata_usaha/jadwal" class="nav-link">
                   <i class="nav-icon fas fa-inbox" style="color :#339af0;"></i>
                   <p>Jadwal WFH dan WFO</p>
            </a>
          </li>
          ...
          <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo base_url()."Pegawai/Pegawai/laporan_harian"?>" class="nav-link">
